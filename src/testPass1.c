 ...
 *
 * OUTPUT:
 *      If debugging has been turned on, the program prints the contents of
 *      the label table it has constructed.  For the example above, the
 *      output might look like:
 *          Label: A_LABEL   Address: 4
 *      (The actual formatting depends on the implementation of the
 *      printLabels function in LabelTableArrayList.c.)
 *
 * ERROR CONDITIONS:
...
int main (int argc, char * argv[])
{
     ...
     *      rewind (fptr);
     *      pass2(fptr, &table);
     * Would also need to update the documentation at the top of this file.
     * The overall description and the description of the Output are both
     * specific to the program's limited role as a test driver to test pass1.
     */
